    ...
    private void displayView(int position) {
        ...
        switch (position){
            ...
            case 4:
                ...
                String fn_ = "men_causal_shirts_file_name";
                String startFromKey_ = "men_casual_shirts_start_key";
                String maxProductsKey_ = "men_casual_shirts_max_products_key";
                String postDataHead_ = "[{\"query\":\"(global_attr_age_group:(\\\"Adults-Men\\\" OR \\\"Adults-Unisex\\\") AND global_attr_article_type_facet:(\\\"Shirts\\\") AND global_attr_usage:(\\\"Casual\\\" OR \\\"Ethnic\\\" OR \\\"Home\\\" OR \\\"NA\\\" OR \\\"Party\\\" OR \\\"Smart Casual\\\" OR \\\"Sports\\\" OR \\\"Travel\\\"))\",\"start\":0,\"rows\":";
                String postDataTail_ = ",\"facet\":true,\"facetField\":[\"Casual_Shoe_Type_article_attr\",\"Upper_Material_article_attr\",\"Fastening_article_attr\",\"Ankle_Height_article_attr\",\"Width_article_attr\"],\"fq\":[\"discounted_price:[499 TO 8199]\",\"count_options_availbale:[1 TO *]\"],\"sort\":[{\"sort_field\":\"count_options_availbale\",\"order_by\":\"desc\"},{\"sort_field\":\"style_store3_male_sort_field\",\"order_by\":\"desc\"},{\"sort_field\":\"potential_revenue_male_sort_field\",\"order_by\":\"desc\"},{\"sort_field\":\"global_attr_catalog_add_date\",\"order_by\":\"desc\"}],\"return_docs\":true,\"colour_grouping\":true}]";
